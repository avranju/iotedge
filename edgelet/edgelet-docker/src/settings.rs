...
mod tests {
    ...
    #[cfg(unix)]
    static GOOD_SETTINGS: &str = "tests/linux/sample_settings.yaml";
    #[cfg(unix)]
    static BAD_SETTINGS: &str = "tests/linux/bad_sample_settings.yaml";
    #[cfg(unix)]
    static GOOD_SETTINGS_TG: &str = "tests/linux/sample_settings.tg.yaml";

    #[cfg(windows)]
    static GOOD_SETTINGS: &str = "tests/windows/sample_settings.yaml";
    #[cfg(windows)]
    static BAD_SETTINGS: &str = "tests/windows/bad_sample_settings.yaml";
    #[cfg(windows)]
    static GOOD_SETTINGS_TG: &str = "tests/windows/sample_settings.tg.yaml";
